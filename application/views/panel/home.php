                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title"><i class="fa fa-comments-o"></i> Kiriman Pesan Terbaru</h3>
                                ...
                                <?php foreach($kiriman as $k):?>
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="<?php echo base_url();?>assets/panel/img/avatar.png" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                                <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?=$k['date']?><?=$k['time']?></small>
                                              <?=$k['fullname']?>
                                            </a>
                                            <?=$k['pesan']?>
                                        </p>
